...
public class ThirdMainFragment extends Fragment {
    ...
    private RelativeLayout linear_chulizhong,linear_daiqueren,linear_yiqueren,linear_wodegongdan;
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()){
                    ...
                    if (totalAlarmModel != null){
                        tv_to_distribute_num.setText(String.valueOf(totalAlarmModel.getUnabs()));
                        ...
                        tv_gongdan_num.setText(String.valueOf(totalAlarmModel.getWorkOrder()));
