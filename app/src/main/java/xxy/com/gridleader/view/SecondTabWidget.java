...
public class SecondTabWidget extends LinearLayout {
    private static final String TAG = TabWidget.class.getSimpleName();
    private int[] mDrawableIds = new int[] { R.drawable.bg_shouye, R.drawable.bg_static,R.drawable.people,R.drawable.bg_wode};
    ...
    public SecondTabWidget(Context context, AttributeSet attrs, int defStyle) {
    ...
    public SecondTabWidget(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SecondTabWidget(Context context) {
        super(context);
        init(context);
    }
...
//				checkedTextView.setTextColor(Color.rgb(19, 12, 14));
    ...
    private TabWidget.OnTabSelectedListener mTabListener;

    public interface OnTabSelectedListener {
        void onTabSelected(int index);
    }

    public void setOnTabSelectedListener(TabWidget.OnTabSelectedListener listener) {
