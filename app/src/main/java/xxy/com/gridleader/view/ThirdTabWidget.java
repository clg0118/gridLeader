...
public class ThirdTabWidget extends LinearLayout {

	private static final String TAG = ThirdTabWidget.class.getSimpleName();
	private int[] mDrawableIds = new int[] { R.drawable.bg_shouye, R.drawable.bg_wenti,R.drawable.bg_wode};
	...
	public ThirdTabWidget(Context context, AttributeSet attrs, int defStyle) {
	...
	public ThirdTabWidget(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ThirdTabWidget(Context context) {
		super(context);
		init(context);
	}
